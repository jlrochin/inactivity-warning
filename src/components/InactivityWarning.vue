<template>
  <div 
    ...
    :class="overlayClass"
  >
    <div class="vue-inactivity-warning-modal" :class="modalClass">
      <!-- Header -->
      <div class="vue-inactivity-warning-header">
        <div class="vue-inactivity-warning-icon" :class="iconClass">
          <slot name="icon">
            <svg class="vue-inactivity-warning-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
